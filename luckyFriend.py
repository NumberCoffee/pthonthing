...
def addfriend():
    ...
    friend_list["text"] = "Your contestants : " + str(list1)
...
def random_number():
    ...
    lucky_friend["text"] = "your lottery winner is: " + str(generated_random_number)

btn = Button(root, text="Add to the contestants", command = addfriend)
btn.place(relx= 0.5,rely = 0.3, anchor = CENTER )

friend_list.place(relx= 0.5,rely = 0.4, anchor = CENTER)

btn1 = Button(root, text="Who is your Lottery winner" , command = random_number)
